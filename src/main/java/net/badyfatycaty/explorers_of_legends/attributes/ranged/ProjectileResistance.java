...
public class ProjectileResistance {
    ...
    public static final DeferredHolder<Attribute, Attribute> PROJECTILE_RESISTANCE = REGISTRY.register("projectile_resistance", () -> new RangedAttribute("attribute.explorers_of_legends.projectile_resistance",
