...
public class ProjectileDamage {
    ...
    public static final DeferredHolder<Attribute, Attribute> PROJECTILE_DAMAGE = REGISTRY.register("projectile_damage", () -> new RangedAttribute("attribute.explorers_of_legends.projectile_damage",
