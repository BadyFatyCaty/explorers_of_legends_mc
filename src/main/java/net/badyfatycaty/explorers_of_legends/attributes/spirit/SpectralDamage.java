...
public class SpectralDamage {
    ...
    public static final DeferredHolder<Attribute, Attribute> SPECTRAL_DAMAGE = REGISTRY.register("spectral_damage", () -> new RangedAttribute("attribute.explorers_of_legends.spectral_damage",
            0, 0, 2048).setSyncable(true).setSentiment(Attribute.Sentiment.POSITIVE));

    @SubscribeEvent
    public static void addAttributes(EntityAttributeModificationEvent event) {
        event.add(EntityType.PLAYER, SPECTRAL_DAMAGE);
    }
}
