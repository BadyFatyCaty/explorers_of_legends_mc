...
public class MaxMana {
    ...
    public static final DeferredHolder<Attribute, Attribute> MAX_MANA = REGISTRY.register("max_mana", () -> new RangedAttribute("attribute.explorers_of_legends.max_mana",
