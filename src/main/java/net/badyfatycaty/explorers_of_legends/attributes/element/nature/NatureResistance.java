...
public class NatureResistance {
    ...
    public static final DeferredHolder<Attribute, Attribute> NATURE_RESISTANCE = REGISTRY.register("nature_resistance", () -> new RangedAttribute("attribute.explorers_of_legends.nature_resistance",
            0, 0, 2048).setSyncable(true).setSentiment(Attribute.Sentiment.POSITIVE));

    @SubscribeEvent
    public static void addAttributes(EntityAttributeModificationEvent event) {
        event.getTypes().forEach(entity -> event.add(entity, NATURE_RESISTANCE));
    }
}
