...
public class EarthResistance {
    ...
    public static final DeferredHolder<Attribute, Attribute> EARTH_RESISTANCE = REGISTRY.register("earth_resistance", () -> new RangedAttribute("attribute.explorers_of_legends.earth_resistance",
