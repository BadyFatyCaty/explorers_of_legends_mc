...
public class AirResistance {
    ...
    public static final DeferredHolder<Attribute, Attribute> AIR_RESISTANCE = REGISTRY.register("air_resistance", () -> new RangedAttribute("attribute.explorers_of_legends.air_resistance",
            0, 0, 2048).setSyncable(true).setSentiment(Attribute.Sentiment.POSITIVE));

    @SubscribeEvent
    public static void addAttributes(EntityAttributeModificationEvent event) {
        event.getTypes().forEach(entity -> event.add(entity, AIR_RESISTANCE));
    }
}
