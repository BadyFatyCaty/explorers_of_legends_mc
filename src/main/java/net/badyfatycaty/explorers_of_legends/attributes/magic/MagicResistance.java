...
public class MagicResistance {
    ...
    public static final DeferredHolder<Attribute, Attribute> MAGIC_RESISTANCE = REGISTRY.register("magic_resistance", () -> new RangedAttribute("attribute.explorers_of_legends.magic_resistance",
