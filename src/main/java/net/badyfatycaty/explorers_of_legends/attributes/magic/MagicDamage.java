...
public class MagicDamage {
    ...
    public static final DeferredHolder<Attribute, Attribute> MAGIC_DAMAGE = REGISTRY.register("magic_damage", () -> new RangedAttribute("attribute.explorers_of_legends.magic_damage",
            0, 0, 2048).setSyncable(true).setSentiment(Attribute.Sentiment.POSITIVE));

    @SubscribeEvent
    public static void addAttributes(EntityAttributeModificationEvent event) {
        event.getTypes().forEach(entity -> event.add(entity, MAGIC_DAMAGE));
    }
}
